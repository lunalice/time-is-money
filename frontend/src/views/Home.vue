  ...
  <div class="home">
    ...
    <table>
      <form id="inputbox">
        <tr>
          <th>a</th>
          <td><input type="text" required placeholder="a" id="input_nen" /></td>
          <td class="soe">a</td>
        </tr>
        <tr>
          <th>b</th>
          <td>
            <input·type="text"·required·placeholder="b"·id="input_money"·/>
          </td>
          <td class="soe">b</td>
        </tr>
        <tr>
          <th>c</th>
          <td>
            <input type="text" required placeholder="c" id="input_rest" />
          </td>
          <td class="soe">c</td>
        </tr>
        <tr>
          <th>d</th>
          <td>
            <input type="text" required placeholder="d" id="input_dotime" />
          </td>
          <td class="soe">d</td>
        </tr>
        <tr>
          <th>e</th>
          <td>
            <input type="text" required placeholder="e" id="input_overtime" />
          </td>
          <td class="soe">e</td>
        </tr>
        <tr>
          <th>f</th>
          <td>
            <input type="text" required placeholder="f" id="input_rostime" />
          </td>
          <td class="soe">f</td>
        </tr>
        <tr>
          <th>g</th>
          <td>
            <input type="text" required placeholder="g" id="input_rosmoney" />
          </td>
          <td class="soe">g</td>
        </tr>
      </form>
    ...
    <!-- あとで直す -->
    <!-- <input type="submit" value="hoge" id="zikko" onclick="simulate();return false;" /> -->
    <div id="result"></div>
